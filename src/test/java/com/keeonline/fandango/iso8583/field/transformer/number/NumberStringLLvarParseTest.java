...
public class NumberStringLLvarParseTest extends TestBase {
	...
	public void parseMaxLength() throws FieldTransformerException {
		...
		result = transformer.parse("FFFFFFF1F0F1F2F3F4F5F6F7F8F9F0FFFFFF",6);
	...
	public void mapPadToMinLength() throws FieldTransformerException {
		...
		FieldTransformer transformer = getTransformer(primitiveSpec);	
		result = transformer.parse("FFFFFF303730303030303037FFFFFF",6);
	...
	public void mapPadToMidLength() throws FieldTransformerException {
		...
		primitiveSpec.addAttribute("code-page","Cp1252");		
		FieldTransformer transformer = getTransformer(primitiveSpec);	
		result = transformer.parse("FFFFFF30383030303030303038FFFFFF",6);
		assertEquals("30383030303030303038",result.getEncoded());
