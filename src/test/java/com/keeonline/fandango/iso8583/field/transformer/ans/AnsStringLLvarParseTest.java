...
public class AnsStringLLvarParseTest extends TestBase {
...
//
	@Test
	public void parseLengthTypeLLNoPaddingEBCDIC() throws FieldTransformerException {
		...
		String payload = "F1F0F1F2F3F4F5F6F7F8F9F0AABBCC";
	...
	@Test
	public void parseLengthTypeLLNoPaddingASCII() throws FieldTransformerException {
		primitiveSpec.addAttribute("value-regex","^\\d{5,10}$");
		primitiveSpec.addAttribute("length-min","5");		
		primitiveSpec.addAttribute("length-max","10");
		primitiveSpec.addAttribute("code-page","Cp1252");		
		FieldTransformer transformer = getTransformer(primitiveSpec);	
		String payload = "AABB313031323334353637383930CCDD";
		String value = "1234567890";
